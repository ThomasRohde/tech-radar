...
const fetchTechnologies = async () => {
    ...
    if (dataSource === 'firestore') {
        ...
        // For now, we'll just log a message and use the local data
        console.log('Fetching from Firestore (not implemented yet)');
        // In the future, you would return the data fetched from Firestore here
    }

    // Simulating an API call (local data for now)
